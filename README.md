...
### [rag-agent-infra-api](https://github.com/guybass/rag-agent-infra-api) — production RAG, batteries included
FastAPI RAG service with ChromaDB, **pluggable LLM providers** (AWS Bedrock / OpenAI / Anthropic), SSE streaming chat, JWT auth, and **Terraform IaC** for one-command AWS deployment.

### [probalistic-latent-spaces](https://github.com/guybass/probalistic-latent-spaces) — are LM representations really linear?
Original research on the **Fisher information geometry of LLM latent spaces**: exact simplex geometry, curvature analysis at the softmax head, and transport-stability bounds — validated on synthetic tasks and Pythia models.

### [devops-agent-k8s-demo](https://github.com/guybass/devops-agent-k8s-demo-master) — the autonomous-DevOps testbed
**19-microservice** EKS deployment with ArgoCD GitOps, Kustomize overlays, External Secrets, HPA/PDB, and network policies — the kind of environment ClouDeus automates.

### [sec-filings-explorer](https://github.com/guybass/sec-filings-explorer) — LLM-assisted EDGAR search
Structured-output LLM search over SEC filings with direct EDGAR document links and saved history (React + Vite).

---

## 🤝 Let's Connect

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2.svg?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://www.linkedin.com/in/guy-basson/)
[![Gmail](https://img.shields.io/badge/Gmail-EA4335.svg?style=for-the-badge&logo=gmail&logoColor=white)](mailto:g.sh.basson@gmail.com)
